...
31% faster than PVSnesLib+816-opt on our benchmark suite. 24 working examples
...
- **Effects**: fading, hdma_wave, gradient_colors, parallax_scrolling, mosaic, transparency, window
- **Input**: two_players
