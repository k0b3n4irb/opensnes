...
; Function: char_to_tile (framesize=16, slots=7, alloc_slots=1)
...
; temp 77: slot=6, alloc=-1
.SECTION ".text.char_to_tile" SUPERFREE
char_to_tile:
	php
	rep #$30
	tsa
...
; Function: print_string (framesize=18, slots=8, alloc_slots=2)
...
; Function: main (framesize=34, slots=16, alloc_slots=2)
...
; temp 81: slot=-1, alloc=-1
; temp 82: slot=12, alloc=-1
; temp 83: slot=13, alloc=-1
; temp 84: slot=-1, alloc=-1
; temp 85: slot=-1, alloc=-1
; temp 86: slot=-1, alloc=-1
; temp 87: slot=8, alloc=-1
; temp 88: slot=-1, alloc=-1
; temp 89: slot=5, alloc=-1
