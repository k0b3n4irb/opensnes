...
```bash
cd examples/graphics/metasprite
make clean && make
...
**Dynamic Sprites:** [Dynamic Sprite](../dynamic_sprite/) - Automatic VRAM

**HDMA Effects:** [HDMA Gradient](../hdma_gradient/) - Per-scanline effects
