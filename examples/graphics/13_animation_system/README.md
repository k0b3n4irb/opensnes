...
```bash
cd examples/graphics/13_animation_system
make clean && make
...
**Metasprites:** [Metasprite](../14_metasprite/) - Large multi-tile sprites

**Dynamic Sprites:** [Dynamic Sprite](../15_dynamic_sprite/) - VRAM management
