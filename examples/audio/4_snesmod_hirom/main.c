 ...
 *
 * Same as 3_snesmod_music but built in HiROM mode (64KB banks).
 * Demonstrates that SNESMOD audio works correctly with HiROM bank mapping.
 *
 * Controls:
 *   A      - Play music
 *   B      - Stop music
 ...
 * Tile indices: 0=space, 1-26=A-Z, 27-36=0-9, 37=-, 38=/, 39=:
 */
...
/* "SNESMOD HIROM MUSIC" */
static const u8 msg_title[] = { 19,14,5,19,13,15,4, 0, 8,9,18,15,13, 0, 13,21,19,9,3, 0xFF };
/* "CONTROLS:" */
